...
extension OutlineView {
  ...
  func initPlayer() {
    guard
      let url = Bundle(for: OutlineView.self).url(forResource: "outline", withExtension: "mov"),
    ...
    NSLayoutConstraint.activate([
      ...
      playerView.widthAnchor.constraint(equalToConstant:1920),
      playerView.heightAnchor.constraint(equalToConstant:700)])
  }
